...
var webFXTreeConfig = {		
	...
	openRootIcon    : this.imagePath + '/greenfoldero1.gif',
	folderIcon      :  this.imagePath + '/greenfolder1.gif',
	openFolderIcon  :this.imagePath + '/greenfoldero1.gif',
	fileIcon        : this.imagePath + '/dc1.gif',
	...
	setImagePath: function(path){  // 设置图片路径。直接设置 imagePath 属性不起作用。
        ...
        //this.imagePath = path;
		this.rootIcon = path + "greenfolder1.gif";
		this.openRootIcon = path + 'greenfoldero1.gif';
		this.folderIcon     =  path + 'greenfolder1.gif';
		this.openFolderIcon  = path + 'greenfoldero1.gif';
		this.fileIcon       = path + 'dc1.gif ';
