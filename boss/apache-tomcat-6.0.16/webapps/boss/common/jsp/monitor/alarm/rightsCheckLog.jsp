...
<title>操作维护日志查询</title>
</head>

<body>
<app:position/>
<app:commonQuery id="commonQueryDefine.oamp.rightsCheckLog.Query" submitAddr="/common/jsp/monitor/alarm/rightsCheckLog.do?methodToCall=openQuery"/>
...
<table width="99%"  border="0" align="center" cellpadding="0" cellspacing="0">
     ...
     <app:toolbar alias="oamp.monitor.rightsCheckLog.delete" title="删除" image="/common/images/detail.gif" function="queryResultForm.action='rightsCheckLog.do?methodToCall=delete' ;queryResultForm.submit()"/>
     													</TR>
                            </TBODY>
                          </TABLE></TD>
                      </TR>
