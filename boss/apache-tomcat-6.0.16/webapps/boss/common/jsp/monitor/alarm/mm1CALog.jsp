...
<title>格式转换日志查询</title>
</head>

<body>
<app:position/>
<app:commonQuery id="queryDefine1.oamp.mm1CALog.Query" submitAddr="/common/jsp/monitor/alarm/mm1CALog.do?methodToCall=openQuery"/>
...
<table width="99%"  border="0" align="center" cellpadding="0" cellspacing="0">
     ...
     <app:toolbar alias="oamp.monitor.mm1CALog.delete" title="删除" image="/common/images/detail.gif" function="queryResultForm.action='mm1CALog.do?methodToCall=delete' ;queryResultForm.submit()"/>
     													</TR>
                            </TBODY>
                          </TABLE></TD>
                      </TR>
