...
<input type="hidden" name="personnel_role_code" value="1">
      ...
      <td>
       <table width="100%"  border="0" align="center" cellpadding="0" cellspacing="0">
         <tr> 
					  ...
					  <td width="100%" background="<%= path %>/common/images/bar_bg.gif"><span class="L style2">添加人事角色</span></td>
           ...
           <td colspan="3"><table width="100%" border="0" cellpadding="0" cellspacing="1" class="T">
             <tr>
              ...
              <table width="100%" border="0" cellspacing="0" cellpadding="3">
                  <tr>
                    <td>人事角色名称：</td>
                    <td><input type='text' name='personnel_role_name' value='' tabindex='2' size='20' maxlength="10"><font color="#FF0000">*</font></td>
                    <td>状态：</td>
