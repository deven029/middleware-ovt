...
<%@ page import="com.ovt.common.web.rights.model.PersonnelRoleSModel"%> 
<%@include file="../frame/check.jsp"%>
<%@ taglib uri="/tags/app" prefix="app"%>

<%
	String treevalue=(String)request.getAttribute("treevalue");
	PersonnelRoleSModel ssm=(PersonnelRoleSModel)request.getAttribute("psm");
%>
...
function form_submit(actionvalue){
 	if (work_form.personnel_role_name.value=="") {
	  alert("请输入功能名称！")
	  	return false;
	}
	if(work_form.personnel_role_name.value.length>40){
	    alert("人事角色名称不能大于40个字符！")
	    return false;
	}
...
<form method='POST' name='work_form' action='personnelRole.do' >
<input type="hidden" name="action_type" value="update">
<input type="hidden" name="personnel_role_code" value="<%=ssm.getPersonnel_role_code()%>">
      ...
      <td>
       <table width="100%"  border="0" align="center" cellpadding="0" cellspacing="0">
         <tr> 
					  ...
					  <td width="100%" background="<%= path %>/common/images/bar_bg.gif"><span class="L style2">修改人事角色</span></td>
           ...
           <td colspan="3"><table width="100%" border="0" cellpadding="0" cellspacing="1" class="T">
             <tr>
              ...
              <table width="100%" border="0" cellspacing="0" cellpadding="3">
                  <tr>
                    <td>人事角色名称：</td>
                    <td><input type='text' name='personnel_role_name' value='<%=ssm.getPersonnel_role_name()%>' tabindex='2' size='20'><font color="#FF0000">*</font></td>
                    <td>状态：</td>
                           ...
                           <table width="30%" border="0" cellspacing="0" cellpadding="0">
													   ...
													   <%
															  for (int i=0;i<next_list.size();i++){
															      ...
															      func="form_submit('personnelRole.do?func_code="+fsm_next.getFunc_code()+"')";
															      }
