...
<%@ page import="com.ovt.idtv.common.web.datapower.DataGroup"%>
<%@include file="../frame/check.jsp"%> 
<%@ taglib uri="/tags/app" prefix="app"%>

<%
	String treevalue=(String)request.getAttribute("treevalue");
	DataGroup group=(DataGroup)request.getAttribute("group");
%>
...
<input type="hidden" name="service_role_code" value=" ">
<input type='hidden' name='parent_code' value=''>
<input type="hidden" name="leafage_flag" value="1">
<input type='hidden' name='data_group_id' value='<%=group.getId()%>'>
           ...
           <td colspan="3"><table width="100%" border="0" cellpadding="0" cellspacing="1" class="T">
             <tr>
              ...
              <table width="100%" border="0" cellspacing="0" cellpadding="3">
                  <tr>
                    <td>数据权限组名称：</td>
                    <td><input type='text' name='datapower_group_name' value='<%=group.getName()%>' tabindex='2' size='20'><font color="#FF0000">*</font></td>
                  </tr>
