...
<html>
  <head>
	...
	<script language="JavaScript">
	  ...
	  function preStep ( )
	  {
		  document.nextForm.action = '<%=request.getContextPath()%>/common/jsp/rights/transfer/choiceExport.do?methodToCall=prevStep';
  ...
  <body>
		...
		<div>
			<br/>
			<form name="nextForm" method = "post" id = "nextForm" action="<%=request.getContextPath()%>/common/jsp/rights/transfer/choiceExport.do?methodToCall=nextStep">
